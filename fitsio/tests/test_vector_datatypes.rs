...
// Commented out u32, as CFITSIO will return error 412 (datatype conversion overflow)
// with any value over 16 bits(!?). Unsigned types are an unofficial CFITSIO extension anyway.
